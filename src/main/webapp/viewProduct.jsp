...
<body>
        ...
        <div class="row border border-3">
            ...
            <div class="col-md-6">
                <div class="container-fluid my-5">
                    ...
                    <span class="real-price"><%=df.format(product.getProductPriceAfterDiscount())%>&#8363;</span>&ensp;
                    <span class="product-price"><%=df.format(product.getProductPrice())%>&#8363;</span>&ensp;
                    <span class="product-discount"><%=product.getProductDiscount()%>&#37;
                        GIẢM</span><br> <span class="fs-5"><b>Trạng thái : </b></span> <span
                        id="availability"> 
                        <%
                            if (product.getProductQunatity() > 0) {
                                out.println("Có sẵn");
                            } else {
                                out.println("Hiện tại hết hàng");
                            }
                        %>
                    ...
                    <form method="post">
                        <div class="container-fluid text-center mt-3">
                            ...
                            <button type="button" onclick="window.open('login.jsp', '_self')"
                                class="btn btn-primary text-white btn-lg">Thêm vào Giỏ</button>
                            &emsp;
                            <button type="button" onclick="window.open('login.jsp', '_self')"
    ...
    <script>
        $(document)
            .ready(
                function() {
                    if ($('#availability').text().trim() == "Hiện tại hết hàng") {
