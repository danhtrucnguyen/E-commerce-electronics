	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (op.trim().equals("changeAddress")) {
			try {
				...
				String userWard = request.getParameter("ward");
			...
			try {
				...
				User user = new User(userName, userEmail, userPhone, userGender, userAddress, userCity, userDistrict,
						userWard);
				user.setUserId(oldUser.getUserId());
				user.setUserPassword(oldUser.getUserPassword());
				user.setDateTime(oldUser.getDateTime());
